 ...
 */
@Singleton
class FetchInterval @Inject constructor() {

    private val db = MangaAppDatabase.DB.chapterDao()
    ...
    suspend fun toUpdatedMangaOrNull(
        manga: Manga,
        ...
        val chapters = db.getAllInManga(manga.id)
